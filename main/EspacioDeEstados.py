...
class EspacioDeEstados:
    ...
    def sucesores(self, estado, d1, tipoHeuristica):
        ...
        listaAdyacentes = sorted(
            listaAdyacentes, key=lambda Edge: (int(Edge.getTargetArista())))
        heuristica = 0
           ...
           # obtenemos el nombre de la calle y la distancia (coste) de cada arista
            for arista in listaAdyacentes:
                ...
                if tipoHeuristica == "euclidea":
                    ...
                    heuristica = self.heuristicaArco(
                        estado.getListaNodos(), self.arcoMinimo())
                ...
                nuevoEstado = Estado(
                    siguienteNodo, listaNuevosNodos, heuristica)
